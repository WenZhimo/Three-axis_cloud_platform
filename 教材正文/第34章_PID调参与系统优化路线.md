...
| 【证据与验证】 | 第4.5节到第4.10.1节、第5.7节到第5.13节、第8.1节到第8.17节、第9节、章节尾部固定检查，以及所有 `【待验证】` 项 | 需要审查固件参数解析、仿真一致性、当前PID来源、`windupGuard` 与限速边界、D项差异、指标记录、`.map/.list/.su/.cyclo` 构建证据或准备仓库外实测记录的读者 |
