...
| 【证据与验证】 | 第8.1节到第8.10.1节、第9节、章节尾部固定检查，以及所有 `【待验证】` 项 | 需要审查启动入口、SysTick/HAL tick、`frame_500Hz`、`.map/.list`、中断 pending/active 状态、DWT/GPIO计时、断点命中或日志证据的读者 |
